				...
				<div class="panel-title">
					<?php
						if ($_SESSION["access_administration_panel"] === '1' || $_SESSION["access_administration_panel"] === '1'){
							echo '<button type="button" name="create_folder" id="create_folder" class="btn btn-xs btn-danger pull-right">Create New Folder</button> CENTRO DE DOWNLOADS ';
						}
						else{
							echo 'CENTRO DE DOWNLOADS';
						}
					?>
				</div>
			</div>
