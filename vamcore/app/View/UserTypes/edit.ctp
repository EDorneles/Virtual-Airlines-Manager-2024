...
<div class="actions">
	...
	<ul class="list-inline">
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('UserType.user_type_id')), array('class' => 'btn btn-md btn-danger'), __('Are you sure you want to delete # %s?', $this->Form->value('UserType.user_type'))); ?></li>
