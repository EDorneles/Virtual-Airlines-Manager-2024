<?php
    ...
    {
?>
<div class="finantialParameters form">
<?php echo $this->Form->create('FinancialParameter'); ?>
	<fieldset>
		<legend><?php echo __('Edit Financial Parameters'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul class="list-inline">
		...
		<li><?php echo $this->Html->link(__('Finantial Parameters'), array('action' => 'index'),array('class' => 'btn btn-md btn-primary')); ?></li>
	</ul>
</div>
<?php
    }
