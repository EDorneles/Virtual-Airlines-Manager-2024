...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="./index.php" class="logo">
      ...
      <span class="logo-lg"><b>P</b>PT</span>
    </a>
...
<li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="./index_vam_op.php?page=pirep_manual_create"><i class="fa fa-hand-pointer-o fa-fw"></i> Enviar vôo Manualmente</a></li>
...
<li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="./index.php?page=route_public"><i class="fa fa-globe fa-fw"></i> Rota</a></li>
...
<?php if ($_SESSION["access_administration_panel"] == 1) { ?>
            ...
            <i class="ion ion-person-add fa-fw"></i><span> (NOVO PILOTO)</span>
            <span class="pull-right-container">
						</span></a>
<?php } ?>
        <li class="header">FORMAÇÃO</li>
        <li><a href="./index_vam_op.php?page=curso_page" target="_blank"><i class="fa fa-graduation-cap fa-fw"></i> CURSOS</a></li>
        <li><a href="./index_vam_op.php?page=training_page" target="_blank"><i class="fa fa-graduation-cap fa-fw"></i> TREINAMENTO</a></li>
...
<li><a href="http://virtualairlinesmanager.net/" target="_blank"><i class="fa fa-globe text-blue"></i> <span> VAM</span></a></li>
  ...
  <div class="content-wrapper">
    ...
    <a href="https://sites.google.com/view/pptvirtual" target="_blank">
      ...
      <small>Acesse aqui o nosso site.</small>
    </a>
